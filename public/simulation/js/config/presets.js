...
export const PRESET_VISUAL = {
  urban_quake: {
    geoShort: "FIRENZE",
    geoTitle: "Urban quake theatre · Protomaps vector · Firenze extract (ODbL) · 300 m",
    basemap: {
      mask: "#0f1726",
      earth: "#121d2e",
      water: "#164969",
    ...
    scene3d: {
      ...
      fogColor: 0x1c2230,
      fogDensity: 0.009,
      ambient: { color: 0x8aa4c4, intensity: 0.95 },
      hemi: { sky: 0x88a8d0, ground: 0x2a2418, intensity: 1.8 },
      key: { color: 0xfff0d8, intensity: 1.7 },
      fill: { color: 0x7aa0c8, intensity: 0.85 },
      rim: { color: 0x66c0ff, intensity: 1.3 },
      gridMat: {
        color: 0x0a1828,
        emissive: 0x001a33,
